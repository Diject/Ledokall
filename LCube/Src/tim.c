...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    hdma_tim1_ch1.Init.MemBurst = DMA_MBURST_INC8;
    ...
    hdma_tim1_ch2.Init.MemBurst = DMA_MBURST_INC8;
    ...
    hdma_tim1_ch3.Init.MemBurst = DMA_MBURST_INC8;
    ...
    hdma_tim1_ch4_trig_com.Init.MemBurst = DMA_MBURST_INC16;
...
inline volatile uint32_t get_device_counter()
{
