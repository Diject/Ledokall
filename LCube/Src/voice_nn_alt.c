...
#define AI_NET_OBJ_INSTANCE g_voice_nn_alt
 
#undef AI_VOICE_NN_ALT_MODEL_SIGNATURE
#define AI_VOICE_NN_ALT_MODEL_SIGNATURE     "c0397e5885b0a4d21e7be4a545d9788d"
...
#define AI_TOOLS_DATE_TIME   "Tue Jan 26 16:11:19 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_VOICE_NN_ALT_N_BATCHES
#define AI_VOICE_NN_ALT_N_BATCHES         (1)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 48, 12, 2), AI_STRIDE_INIT(4, 4, 4, 192, 2304),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 27, 2), AI_STRIDE_INIT(4, 4, 4, 64, 1728),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 32, 15, 1, 1), AI_STRIDE_INIT(4, 4, 128, 1920, 1920),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1152, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4608, 147456, 147456),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 16, 2, 2, 48), AI_STRIDE_INIT(4, 4, 64, 128, 256),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 29, 21), AI_STRIDE_INIT(4, 4, 4, 4, 116),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 28, 20), AI_STRIDE_INIT(4, 4, 4, 64, 1792),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 13, 9), AI_STRIDE_INIT(4, 4, 4, 64, 832),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 48, 6, 4), AI_STRIDE_INIT(4, 4, 4, 192, 1152),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 40192, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_VOICE_NN_ALT_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_VOICE_NN_ALT_OUT_NUM, &dense_4_nl_output),
  &conv2d_4_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool voice_nn_alt_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_6_scratch0_array.data = AI_PTR(activations + 7488);
    conv2d_6_scratch0_array.data_start = AI_PTR(activations + 7488);
    conv2d_5_scratch0_array.data = AI_PTR(activations + 36736);
    conv2d_5_scratch0_array.data_start = AI_PTR(activations + 36736);
    input_0_output_array.data = AI_PTR(NULL);
    input_0_output_array.data_start = AI_PTR(NULL);
    conv2d_4_output_array.data = AI_PTR(activations + 896);
    conv2d_4_output_array.data_start = AI_PTR(activations + 896);
    conv2d_5_output_array.data = AI_PTR(activations + 0);
    conv2d_5_output_array.data_start = AI_PTR(activations + 0);
    conv2d_6_output_array.data = AI_PTR(activations + 12096);
    conv2d_6_output_array.data_start = AI_PTR(activations + 12096);
    dense_3_output_array.data = AI_PTR(activations + 0);
    dense_3_output_array.data_start = AI_PTR(activations + 0);
    dense_3_nl_output_array.data = AI_PTR(activations + 128);
    dense_3_nl_output_array.data_start = AI_PTR(activations + 128);
...
AI_DECLARE_STATIC
ai_bool voice_nn_alt_configure_weights(
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_4_bias_array.data = AI_PTR(weights + 166464);
    dense_4_bias_array.data_start = AI_PTR(weights + 166464);
    dense_4_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_weights_array.data = AI_PTR(weights + 164544);
    dense_4_weights_array.data_start = AI_PTR(weights + 164544);
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(weights + 164416);
    dense_3_bias_array.data_start = AI_PTR(weights + 164416);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 16960);
    dense_3_weights_array.data_start = AI_PTR(weights + 16960);
    conv2d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_bias_array.data = AI_PTR(weights + 16768);
    conv2d_6_bias_array.data_start = AI_PTR(weights + 16768);
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_VOICE_NN_ALT_MODEL_NAME,
      .model_signature   = AI_VOICE_NN_ALT_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= voice_nn_alt_configure_weights(net_ctx, &params->params);
  ok &= voice_nn_alt_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_voice_nn_alt_forward(ai_handle network, const ai_buffer* input)
{
